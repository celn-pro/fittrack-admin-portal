...
import { type HealthTipInput } from '../../types';
import HealthTipFormField from '../common/HealthTipFormField';

interface HealthTipFormBuilderProps {
  initialValues?: Partial<HealthTipInput>;
  onSubmit: (data: HealthTipInput) => void;
  onCancel?: () => void;
  theme: 'light' | 'dark';
}

const HealthTipFormBuilder: React.FC<HealthTipFormBuilderProps> = ({
  initialValues = {},
  onSubmit,
  onCancel,
  theme,
}) => {
  const [form, setForm] = useState<HealthTipInput>({
    ...initialValues,
  ...
  const handleChange = (field: keyof HealthTipInput, value: any) => {
...
export default HealthTipFormBuilder;